    ...
    <div class="mt-6 flex items-center justify-between gap-4 rounded-xl border border-slate-800 bg-[#07111f] p-4">
        ...
        <div class="flex gap-2">
            ...
            <div class="flex gap-1">
                ...
                @foreach ($elements[1] as $page => $url)
                    ...
                    @else
                        <a href="{{ $url }}" class="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-slate-700 text-xs font-semibold text-slate-300 hover:border-cyan-400/30 hover:text-cyan-300 transition">
                            {{ $page }}
                        </a>
                    @endif
                @endforeach
